...
<html lang="ru">
  <head>
    ...
    <title>Отправить фото — αTBOTsender</title>
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
          <ul id="hetop" class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="./sendphoto.php?token=<?php echo $_REQUEST['token']; ?>&chat_id=<?php echo $_REQUEST['chat_id']; ?>">Отправить фото</a> </li>
    ...
    <div class="container-fluid">
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="alert alert-info"><b>Важно!</b> Размер изображения не должен привышать 10Мб</div>
          <h3>Отправить фото <small>только в формате JPG</small></h3>
          <form action="<?php echo "https://telegg.ru/orig/bot"?><?php echo $_REQUEST['token']; ?><?php echo "/sendPhoto" ?>" method="post" enctype="multipart/form-data">
            <input type="text" name="chat_id" value="<?php echo $_REQUEST['chat_id']; ?>" style="display: none;" />
              <div class="input-group">
                ...
                <input class="form-control" type="file" accept=".JPG" name="photo" style="display: none;">
              </div>
        ...
        $('form').on('submit', function(e){
          ...
          $.ajax({
            ...
            success: function(json, status, success){
              ...
              $('#api').html('<p><b>Статус: </b>Отправлено</p><p><b>ID сообщения: </b>' + json.result.message_id + '</p><p><b>ID файла: </b>' + json.result.photo[0].file_id + '</p><p><b>Получатель: </b>' + recipient + ' (<a href="https://tggm.ga/' + json.result.chat.username + '">@' + json.result.chat.username + '</a>)' + '</p>');
              progressBar.val(0);
