...
<html lang="ru">
  <head>
    ...
    <title>Отправить аудио — αTBOTsender</title>
      ...
      <div class="container-fluid">
        ...
        <div class="navbar-collapse collapse">
          <ul id="hetop" class="nav navbar-nav navbar-right">
            ...
            <li class="active"><a href="./sendaudio.php?token=<?php echo $_REQUEST['token']; ?>&chat_id=<?php echo $_REQUEST['chat_id']; ?>">Отправить аудио</a> </li>
      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="alert alert-info"><b>Важно!</b> Размер файла не должен привышать 50Мб</div>
            <h3>Отправить аудио <small>только в формате MP3</small></h3>
            <form action="<?php echo "https://telegg.ru/orig/bot"?><?php echo $_REQUEST['token']; ?><?php echo "/sendAudio" ?>" method="post" enctype="multipart/form-data">
              ...
              <div class="input-group">
                <div class="file_upload">
                  ...
                  <input class="form-control" type="file" accept=".MP3" name="audio" style="display: none;">
                </div>
        ...
        $('form').on('submit', function(e){
          ...
          $.ajax({
            ...
            success: function(json, status, success){
              ...
              $('#api').html('<p><b>Статус: </b>Отправлено</p><p><b>ID сообщения: </b>' + json.result.message_id + '</p><p><b>Трек: </b>' + json.result.audio.performer + ' - ' + json.result.audio.title + '</p><p><b>ID файла: </b>' + json.result.audio.file_id + '</p><p><b>Получатель: </b>' + recipient + ' (<a href="https://tggm.ga/' + json.result.chat.username + '">@' + json.result.chat.username + '</a>)' + '</p>');
              progressBar.val(0);
