      ...
      <div class="row">
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
          <div class="alert alert-info"><b>Важно!</b> Размер файла не должен привышать 50Мб</div>
            ...
            <form action="<?php echo "https://api.telegram.org/bot"?><?php echo $_REQUEST['token']; ?><?php echo "/sendAudio" ?>" method="post" enctype="multipart/form-data">
        ...
        $('form').on('submit', function(e){
          ...
          $.ajax({
            ...
            success: function(json, status, success){
              ...
              $('#api').html('<p><b>Статус: </b>Отправлено</p><p><b>ID сообщения: </b>' + json.result.message_id + '</p><p><b>Трек: </b>' + json.result.audio.performer + ' - ' + json.result.audio.title + '</p><p><b>ID файла: </b>' + json.result.audio.file_id + '</p><p><b>Получатель: </b>' + recipient + ' (<a href="https://t.me/' + json.result.chat.username + '">@' + json.result.chat.username + '</a>)' + '</p>');
              progressBar.val(0);
