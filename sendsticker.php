...
<head>
  ...
  <title>Отправить стикер — αTBOTsender</title>
    ...
    <div class="container-fluid">
      ...
      <div class="navbar-collapse collapse">
        <ul id="hetop" class="nav navbar-nav navbar-right">
          ...
          <li class="active"><a href="./sendsticker.php?token=<?php echo $_REQUEST['token']; ?>&chat_id=<?php echo $_REQUEST['chat_id']; ?>">Отправить стикер</a> </li>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
        <div class="alert alert-info"><b>Важно!</b> Размер стикера должен быть не больше 512х512px</div>
        <h3>Отправить стикер <small>только в формате PNG</small></h3>
        <form action="<?php echo "https://telegg.ru/orig/bot"?><?php echo $_REQUEST['token']; ?><?php echo "/sendSticker" ?>" method="post" enctype="multipart/form-data">
          ...
          <div class="input-group">
            <div class="file_upload">
              ...
              <input class="form-control" type="file" accept=".PNG" name="sticker" style="display: none;">
            </div>
      ...
      $('form').on('submit', function(e){
        ...
        $.ajax({
          ...
          success: function(json, status, success){
            ...
            $('#api').html('<p><b>Статус: </b>Отправлено</p><p><b>ID сообщения: </b>' + json.result.message_id + '</p><p><b>ID файла: </b>' + json.result.sticker.file_id + '</p><p><b>Получатель: </b>' + recipient + ' (<a href="https://tggm.ga/' + json.result.chat.username + '">@' + json.result.chat.username + '</a>)' + '</p>');
            progressBar.val(0);
